...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT_wrapper(
        ...
        _______, ________________NAV_L3_3x5_________________,    ________________NAV_R3_3x5_________________, _______,
                                    _______, KC_ESC,  KC_ENT,    KC_TAB, KC_DEL, _______
    ),
    [_SYM] = LAYOUT_wrapper(
    ...
    [_ADJUST] = LAYOUT_wrapper(
        RESET,   _______________ADJUST_L1_3x5_______________,    _______________ADJUST_R1_3x5_______________, RGB_TOG,
        RGB_VAI, _______________ADJUST_L2_3x5_______________,    _______________ADJUST_R2_3x5_______________, RGB_VAI,
        RGB_MOD, _______________ADJUST_L3_3x5_______________,    _______________ADJUST_R3_3x5_______________, RGB_MOD,
